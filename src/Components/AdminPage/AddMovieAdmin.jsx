...
import { removeMovie } from "../../features/LoginPage/LoginPageSlice";
                ...
                return (
                  ...
                  >
                    <tr className="text-center hover:bg-slate-200">
                      ...
                      <td className="">
                        <button  className="text-black hover:text-red-800 px-2 rounded text-[14px]" onClick={() => handleRemoveData(e.id)}>
                          Remove
                        </button>
                      </td>
                    </tr>
